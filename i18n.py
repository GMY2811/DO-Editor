...
_STRINGS = {
    ...
    "replace_text_hint": ("编辑模式：可修改文字，并可移动、缩放、旋转、替换或删除图片和签名",
                          "Edit mode: edit text, or move, resize, rotate, replace, and delete images and signatures"),
    ...
    "modify_watermark": ("修改水印", "Modify Watermark"),
    "delete_watermark": ("删除水印", "Delete Watermark"),
    "detect_watermark": ("检测疑似水印", "Detect Suspected Watermarks"),
    "watermark_none": ("未发现可管理的水印", "No manageable watermarks were found."),
    "watermark_candidate_none": ("未发现可安全隔离的疑似水印",
                                 "No safely isolated watermark candidates were found."),
    "watermark_choose": ("请选择水印：", "Select a watermark:"),
    "watermark_choose_candidate": ("请选择要检查的疑似水印：",
                                    "Select a suspected watermark to inspect:"),
    "watermark_modified": ("已修改水印", "Watermark modified"),
    "watermark_deleted": ("已删除水印", "Watermark removed"),
    "watermark_modify_failed": ("无法修改该水印", "This watermark could not be modified."),
    "watermark_delete_failed": ("无法删除该水印", "This watermark could not be removed."),
    "watermark_delete_confirm": ("确定删除“{name}”吗？此操作可以撤销。",
                                 "Remove “{name}”? This action can be undone."),
    "watermark_candidate_confirm": (
        "检测到“{name}”位于独立页面内容流中。\n\n"
        "将只删除该独立内容流，不会对白色区域执行覆盖或擦除。是否继续？",
        "“{name}” was found in an isolated page content stream.\n\n"
        "Only that isolated stream will be removed; no area redaction or white overlay will be used. Continue?"),
    "watermark_embedded_image": ("文档内嵌图片", "Embedded document image"),
    "watermark_external_replace": ("外部水印将替换为新的 DO 编辑器水印。",
                                   "The external watermark will be replaced with a new DO Editor watermark."),
    ...
    "print_invalid_range": ("打印页码范围无效，请检查起始页和结束页。",
                            "Invalid page range. Check the first and last page numbers."),
    "print_paper_unsupported": ("当前打印机未列出 {paper} 纸张支持，请选择其他纸张。",
                                "This printer does not list support for {paper}. Please choose another paper size."),
    "print_paper_rejected": ("打印机未接受纸张 {paper}，请选用驱动支持的纸张。",
                             "The printer did not accept {paper}. Please choose a paper size supported by its driver."),
    "print_paper_mismatch": ("打印机实际纸张与所选尺寸不一致，请检查驱动纸张设置。",
                             "The printer's paper size does not match your selection. Please check the driver settings."),
    ...
    "insert_blank_page": ("插入空白页", "Insert Blank Page"),
    "add_blank_page": ("添加空白页", "Add Blank Page"),
    "insert_blank_done": ("已插入空白页", "Blank page inserted"),
